...
![](https://tianji.zahno.dev/telemetry/clnzoxcy10001vy2ohi4obbi0/cm7hhb3lf0038ru047n9dnhvt.gif)
...
![sample](https://github.com/hei-templates/hei-synd-report/blob/main/sample.png)
...
1. In the `Typst` Univers select the `hei-synd-report` template. Locally you can use the Typst CLI to initialise the project:
   ...
   typst init @preview/hei-synd-report:0.2.0
   ```
...
All metadata is optional, but it is recommended to fill in as much as possible. The metadata is divided into three sections: `options`, `doc`, and `settings`.
   ...
   | `doc.school.major_url`       | _string_                    | URL of the major                                                                                    |
   | `doc.school.orientation`     | _content_                   | Orientation of the school                                                                           |
   | `doc.school.orientation_url` | _string_                    | URL of the orientation                                                                              |
   ...
   | `doc.course.email`           | _string_                    | Email of the professor                                                                              |
...
All notable information about contributing to this project can be found in the [CONTRIBUTING.md](https://github.com/hei-templates/hei-synd-report/blob/main/CONTRIBUTING.md) file.
...
All notable changes to this project are documented in the [CHANGELOG.md](https://github.com/hei-templates/hei-synd-report/blob/main/CHANGELOG.md) file.
